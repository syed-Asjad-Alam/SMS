...
namespace CoursesWebApi.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        [Route("[action]")]
        [HttpGet]
        public async Task<ActionResult<IEnumerable<AllocatedCourses>>> GetJoinedTable()
        {
            return (from StudentCourses in _studentDbContext.StudentCourses
        ...
        [Route("[action]")]
        [HttpGet]
        //Task<ActionResult<IEnumerable<AllocatedCourses>>>
        public async Task<ActionResult<IEnumerable<AllocatedCourses>>> StudentCoursefilter(String? student,String? course)
        {
            var studentcourses = GetJoinedTable().Result.Value.AsQueryable();
            //var studentcourses = _studentDbContext.AllocatedCourses.AsQueryable();
            try
            {
