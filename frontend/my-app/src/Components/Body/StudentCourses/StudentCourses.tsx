...
function StudentCourses () {
    ...
    const fetchdata = () => {
        ...
        fetch('https://localhost:7034/api/Student/GetJoinedTable').then((res)=>res.json())
        .then((json)=> {
            setRowData(json)
        })
    }
    ...
    return(
        <div className="mycss">
            ...
            <div className="ag-theme-alpine">
                {filteropen?<StudentCourseFilter fetchdata={fetchdata} filterresult={filterresult} setFilterOpen={setFilterOpen} />:
                <div>
                <div className="entityicon">
                <img src={studentcourseicon}></img>
                </div>
                <div className="dir">
